...
:::warning[Importante]
La solución a este problema TIENE una restricción importante y es 
que debes utilizar la misma arquitectura de máquina de estados que
hemos venido trabajando en las actividades anteriores. También debes 
usar la clase Timer para gestionar el tiempo. Si no cumples con esta 
restricción, aunque tu aplicación funcione correctamente, el criterio 
C1 de la rúbrica analítica será calificado con 0.0.
:::
...
:::caution[📤 Bitácora]
1. Construye la máquina de estados que modela el problema usando [PlanUML](https://plantuml.com/). 
